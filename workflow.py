...
m = crease_he.Model(optim_params = [10, 11],# [10, 4, 7],
                 adapt_params = [0.9, 0.6],# [0.005,0.85,0.1,1,0.006,0.25,1.1,0.6,0.001],
                opt_algorithm = "ghs")
...
#os.mkdir("./test_outputs_3")
m.solve(output_dir='./test_outputs_3')