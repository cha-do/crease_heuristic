                    ...
                    for i in candidateReady:
                        if self.fitcandidates[i] < self.WL_fit[self.worst_idWL]:
                            ...
                            with open(self.address+'tabuList.txt','a') as f:
                                ...
                                f.write('\n')
                            imp = True
                            if self.fitcandidates[i] < self.harmony_fit[self.worst_id]:   
                                ...
                                self.harmonies[self.worst_id] = self.candidates[i]
                                self.harmony_fit[self.worst_id] = self.fitcandidates[i]
                                self.compTimesHM[self.worst_id] = self.comptimescandidates[i]
                                if self.fitcandidates[i] < self.bestfit:
                                    if not Imp:
                                    ...
                                    self.bestfit = self.fitcandidates[i]
                                self.worst_id = np.argmax(self.harmony_fit)
                            else:
