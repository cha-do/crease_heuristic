...
if __name__ == "__main__":
    # %% Load shape
    data = np.genfromtxt("ICOMP_DATA/7_15_6_12_6.txt")
    q_range = data[:,0]
    Iqexp = data[:,1]
    iqs = []
    qs = []
    ...
    params = [[150, 60, 120, 60, 0.2, 0.2, bg]]
    ...
    for i in range(0,len(iqs)):
        ax.plot(q_range,iqs[i],color=colors[i],linestyle='-',ms=8,linewidth=1.3,marker=',',label=f'ns=54')
